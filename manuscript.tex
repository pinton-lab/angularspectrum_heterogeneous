...
\cite{christopher1991,du1994,zemp2010} offers an attractive
...
\cite{christopher1991,zemp2010,du1994} and remain valuable here as
...
\textit{J.\ Acoust.\ Soc.\ Am.}, vol.~96, no.~5, pp.~2866--2874, 1994.
...
\bibitem{guasch2020}
L.~Guasch, O.~C. Agudo, M.-X. Tang, P.~Nachev, and M.~Warner,
``Full-waveform inversion imaging of the human brain,''
\textit{npj Digit.\ Med.}, vol.~3, art.~28, 2020.

\bibitem{halle_skull}
M.~Pham, Y.~Huang, and Y.~Bhatt,
``Halle skull microCT dataset,'' Zenodo, 2022.
\url{https://doi.org/10.5281/zenodo.6956658}
...
\bibitem{pinton2012}
G.~F. Pinton, J.-F. Aubry, E.~Bossy, M.~Muber, and M.~Tanter,
...
\bibitem{pinton2014}
G.~F. Pinton, J.~Dahl, and G.~E. Trahey,
``Software and techniques for three-dimensional full-wave nonlinear
acoustic simulations,'' unpublished Fullwave implementation, 2014--2026.
...
\bibitem{pinton2017}
G.~F. Pinton,
``Angular spectrum method code,'' unpublished MATLAB implementation, 2017.
